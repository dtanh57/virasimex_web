      ...
      {(data || []).map((item, index) => {
        return (
          <Grid
            key={`${index}`}
            container
            sx={{ p: 10, backgroundColor: item.backgroundColor }}
          >
            <Grid
              item
              lg={6}
              ...
              textAlign="center"
              sx={{
                display: { md: item.imgLeft ? "block" : "none", xs: "block" },
                mb: { xs: 2 },
              }}
            >
            ...
            <Grid
              ...
              textAlign="center"
              sx={{
                display: { md: !item.imgLeft ? "block" : "none", xs: "none" },
              }}
            >
              <AppAnimationWhenVisible>
                <img
